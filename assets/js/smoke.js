...
function init() {
    ...
    smokeMaterial = new THREE.MeshLambertMaterial({color: 0xe483f5, map: smokeTexture, transparent: true});
    ...
    document.getElementById('renderSmoke').appendChild( renderer.domElement );
